...
const body = (res: { body: unknown }): ResponseBody => res.body as ResponseBody;
...
describe('Auth (e2e)', () => {
  ...
  async function registerConfirmAndLogin(
    ...
    const res = await request(app.getHttpServer())
      ...
      .send({ email, password });
    return {
      access_token: body(res).access_token as string,
      refresh_token: body(res).refresh_token as string,
    };
  }
